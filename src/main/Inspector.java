...
public class Inspector
{
    ...
    Button sToggle,fToggle,aToggle,iToggle,stringToggle;
    ...
    {
        if(fToggle.contains(x,y) || sToggle.contains(x,y) || aToggle.contains(x,y) || iToggle.contains(x,y) || stringToggle.contains(x,y))
        {
            return true;
        }
        return false;
